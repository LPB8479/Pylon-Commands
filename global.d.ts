...
declare module pylon {
	...
	class KVNamespace {
		...
		transactMultiWithResult<T1 extends Json, T2 extends Json, R>(
			keys: [string, string],
			transaction: (prev: [T1 | undefined, T2 | undefined]) => {
...
declare module discord {
	...
	class Guild {
	  ...
	  */
		...
		getChannel(
			channelId: Snowflake,
		): Promise<Channel.AnyGuildChannel | null>;
		 ...
		 */
		editRolePositions(
			rolePositions: Array<discord.Guild.IRolePositionOptions>,
		): Promise<Role[]>;
		 ...
		 */
		iterMembers(
			options?: Guild.IIterMembersOptions,
		 ...
		 */
		createEmoji(
			options: discord.Guild.ICreateEmojiOptions,
		): Promise<discord.Emoji>;
		 ...
		 */
		setOwnVoiceState(
			options: discord.Guild.ISetVoiceStateOptions,
		): Promise<void>;
		 ...
		 */
		previewPrune(
			options?: discord.Guild.IPreviewPruneOptions,
		): Promise<number>;
		...
		beginPrune(
			options: discord.Guild.IPruneOptions & {computePruneCount: false},
		): Promise<void>;
	}
	...
	interface ITextChannel {
		 ...
		 */
		sendMessage(
			content: Message.OutgoingMessageArgument<string>,
		): Promise<Message>;
		 ...
		 */
		sendMessage(
			embed: Message.OutgoingMessageArgument<Embed>,
		): Promise<Message>;
	...
	class GuildChannel extends Channel implements IMentionable {
		 ...
		 */
		createInvite(
			options?: discord.Invite.ICreateInviteOptions,
	...
	namespace GuildCategory {
		interface IGuildCategoryOptions
	...
	namespace GuildStageVoiceChannel {
		interface IGuildStageVoiceChannelOptions
			extends GuildChannel.IGuildChannelOptions {}
	}
	...
	class GuildNewsChannel extends GuildChannel implements ITextChannel {
		 ...
		 */
		publishMessage(
			messageId: discord.Snowflake | discord.Message,
	...
	namespace Message {
		 ...
		 */
		type OutgoingMessageArgument<T extends OutgoingMessage> =
			| T
			| Promise<T>
			| (() => Promise<T>);
	}
	...
	namespace Invite {
		 ...
		 * Options used when creating an invite, typically with [[discord.GuildChannel.createInvite]].
		 */
		interface ICreateVoiceChannelInviteOptions
			extends ICreateInviteOptions {
			/**
	...
	class VoiceState {
		 ...
		 */
		getChannel(): Promise<
			discord.GuildVoiceChannel | discord.GuildStageVoiceChannel | null
		>;
		/**
	...
	function on(
		...
		handler: (
			member: Event.IGuildMemberRemove,
	...
	function getTextChannel(
		channelId: discord.Snowflake,
	): Promise<discord.ITextChannel | null>;
	 ...
	 */
	function getGuildCategory(
		channelId: discord.Snowflake,
	): Promise<discord.GuildCategory | null>;
	...
	namespace interactions {
		...
		namespace commands {
			...
			class SlashCommandInteraction {
				 ...
				 */
				respond(
					response: string | IResponseMessageOptions,
			...
			type OptionsFactory<T extends ResolvedOptions> = (
				args: IOptionProviders,
			) => T;
			...
			class SlashCommandResponse {
				 ...
				 */
				edit(
					editedResponse: string | IResponseMessageEditOptions,
				): Promise<void>;
	...
	namespace command {
		...
		namespace filters {
			 ...
			 */
			function userIdIn(
				userIds: Array<discord.Snowflake>,
			): ICommandFilter;
			 ...
			 */
			function channelIdIn(
				channelIds: Array<discord.Snowflake>,
			): ICommandFilter;
			 ...
			 */
			function parentIdIn(
				parentIds: Array<discord.Snowflake>,
			): ICommandFilter;
			 ...
			 */
			function canCreateInstantInvite(
				channelId?: discord.Snowflake,
			): ICommandFilter;
			 ...
			 * will be checked in.
			 */
			function canManageChannelWebhooks(
				channelId?: discord.Snowflake,
			): ICommandFilter;
			 ...
			 * will be checked in.
			 */
			function canReadMessageHistory(
				channelId?: discord.Snowflake,
			): ICommandFilter;
		...
		interface ICommandArgs {
			 ...
			 */
			stringOptional(
				options: IOptionalArgumentOptions<string> &
					IStringArgumentOptions,
			): string;
			stringOptional(
				options?: IArgumentOptions & IStringArgumentOptions,
			): string | null;
			 ...
			 */
			integer(
				options?: IArgumentOptions & INumericArgumentOptions,
			): number;
			/**
			 ...
			 */
			integerOptional(
				options: IOptionalArgumentOptions<number> &
					INumericArgumentOptions,
			): number;
			integerOptional(
				options?: IArgumentOptions & INumericArgumentOptions,
			): number | null;
		 ...
		 */
		type CommandArgumentsContainer = {
			[key: string]: CommandArgumentTypes;
		} | null;
		 ...
		 */
		type ArgumentsParser<T extends CommandArgumentsContainer> = (
			args: ICommandArgs,
		) => T;
		...
		class CommandGroup implements ICommandExecutor {
			 ...
			 */
			attach(executors: {
				[name: string]: discord.command.ICommandExecutor;
			}): this;
			...
			subcommand(
				options:
					| string
					| Named<Omit<ICommandGroupOptions, 'filters' | 'register'>>,
